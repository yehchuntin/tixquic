    ...
    return (
      <div
        ...
        className={cn(
          ...
          // className prop for Sidebar is applied to the inner visual div, not this peer div.
        )}
        data-state={state}
      ...
      >
        ...
        <div
          className={cn(
            ...
            className // className prop from <Sidebar> is applied here to the visual fixed part
          )}
          {...props} // other props are applied here too
        >
          <div
            data-sidebar="sidebar"
  ...
  return (
    <main
      ...
      className={cn(
        ...
        // Removed peer-data classes specific to variant="inset" as they don't apply to default "sidebar" variant
        className
      )}
      {...props}
    />
